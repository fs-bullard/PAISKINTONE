...
if __name__ == "__main__":
    ...
    data_folder = Path("/Volumes/Extreme SSD/Papers/PAISKINTONE/Final Cohort/Data")
    output_folder = Path(
        "/Volumes/Extreme SSD/Papers/PAISKINTONE/Final Cohort/US from PA"
    )
    ...
    # Get model matrix
    m = load_npz(
        "/Volumes/Extreme SSD/Scripts/PAISKINTONE Model Based Reconstructor/forward_model.npz"
    )
